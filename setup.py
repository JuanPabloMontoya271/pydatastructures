...
setup(
  ...
  url = 'https://github.com/JuanPabloMontoya271/python_datastructures',   
  download_url = "https://github.com/JuanPabloMontoya271/python_datastructures/archive/v_01.1.1.tar.gz",
